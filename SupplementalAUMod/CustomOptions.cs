...
public class CustomOptionHolder {
    ...
    public static void Load()
    {
        ...
        adminTimer = CustomOption.Create(100, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "Admin Map Available Duration"), CustomOptionType.General, 10f, 0f, 120f, 1f);
        enabledAdminTimer = CustomOption.Create(101, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "Enable Admin Map Available Duration"), CustomOptionType.General, true);
